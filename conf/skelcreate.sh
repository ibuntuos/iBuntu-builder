...
echo "sudo cp -r /home/$username/.config /etc/skel"
sudo cp -r /home/$username/.config /etc/skel
...
sudo cp -r /home/$username/.sudo_as_admin_successful /etc/skel
sudo cp -r /home/$username/.Xauthority /etc/skel
...
sudo chown -R 1000:1001 /etc/skel
